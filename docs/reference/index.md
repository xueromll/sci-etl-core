...
| Page | Package | Covers |
|------|---------|--------|
| [Pipelines](pipelines.md) | `sci_etl_core` | `AsyncETLPipeline`, `ETLPipeline`, memory ingestion, sync adapters, `ShutdownSignal`, progress events and `RunMetrics` |
...
| [LLM](llm.md) | `sci_etl_core.llm` | LLM clients, response caching, relevance filters, entity extractors |
...
| [Utilities](utilities.md) | defining module | HTTP clients, rate limiters, including per-host limits, logging |
